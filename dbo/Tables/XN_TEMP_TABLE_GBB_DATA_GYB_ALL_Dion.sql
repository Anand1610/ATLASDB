CREATE TABLE [dbo].[XN_TEMP_TABLE_GBB_DATA_GYB_ALL_Dion] (
    ...
    [FLT_BILL_AMOUNT]        NVARCHAR (1000) NULL,
    [FLT_PAID]               NVARCHAR (1000) NULL,
    ...
    CONSTRAINT [PK_XN_TEMP_TABLE_GoGBB_ALL_Dino] PRIMARY KEY CLUSTERED ([SZ_BILL_NUMBER] ASC)
);
