CREATE TABLE [dbo].[tblProviderCase] (
    ...
    [Date_Opened_Full]                      DATETIME        CONSTRAINT [DF_tblcase_Date_Opened_Full1] DEFAULT (getdate()) NULL,
    ...
    [Group_Data]                            INT             NULL,
    [Group_Id]                              INT             NULL,
    [Date_Status_Changed]                   DATETIME        CONSTRAINT [DF_tblcase_Date_Status_Changed1] DEFAULT (getdate()) NULL,
    ...
    [BX_Originated]                         BIT             CONSTRAINT [DF_tblcase_BX_Originated1] DEFAULT ((0)) NULL,
    ...
    [DomainId]                              NVARCHAR (50)   CONSTRAINT [DF__tblcase__DomainI__29E1370A1] DEFAULT ('h1') NULL,
