...
-- =============================================
CREATE PROCEDURE [dbo].[Report_Voluntary_Payment_Undeposited]
...
BEGIN
	...
	AND (
		...
		OR
	     (@dt_a_FromclearDate<>'' AND @dt_a_ToclearDate<>'' AND cpt.VAL_Cleared_Date BETWEEN CONVERT(datetime,@dt_a_FromclearDate) AND CONVERT(datetime,@dt_a_ToclearDate) + 1 )
		)	
