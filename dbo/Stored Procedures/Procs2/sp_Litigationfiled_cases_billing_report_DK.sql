CREATE PROCEDURE sp_Litigationfiled_cases_billing_report_DK

As
BEGIN
--exec sp_Litigationfiled_cases_billing_report_DK
...
SELECT DISTINCT 
	...
	WHERE  n.[Notes_Desc] Like '%to Litigation filed%' And 
