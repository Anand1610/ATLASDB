CREATE PROCEDURE [dbo].[SP_GET_DENIALREASONS_REPORT]-- 'COUNTRY WIDE REDACTED DENIAL'
...
BEGIN
	...
	SET @DENIAL_ID = (SELECT DenialReasons_Id FROM TBLDENIALREASONS WHERE DENIALREASONS_TYPE=@Denial_Type and DomainId = @DomainID)
	INSERT INTO #TEMP
	select
	tblcase.Case_Id,
	tblcase.Case_Code,   
