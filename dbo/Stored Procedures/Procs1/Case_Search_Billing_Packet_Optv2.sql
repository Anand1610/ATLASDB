CREATE PROCEDURE [dbo].[Case_Search_Billing_Packet_Optv2] -- [Case_Search_Billing_Packet] 'glf'
	(
	@DomainID VARCHAR(50)
...
BEGIN
	...
	DECLARE @caseData Table
		...
		SELECT DISTINCT cas.Case_Id
			...
			,Provider_Name + ISNULL(' [ ' + cas.Provider_Groupname + ' ]', '') AS Provider_Name
			,cas.InsuranceCompanyName as InsuranceCompany_Name
