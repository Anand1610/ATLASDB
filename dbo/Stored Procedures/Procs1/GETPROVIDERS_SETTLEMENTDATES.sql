CREATE PROCEDURE [dbo].[GETPROVIDERS_SETTLEMENTDATES] --'0','1993','01/01/2008','01/01/2011','',''
(
...
BEGIN
	...
	SET @STRQUERY = 'SELECT 
				YEAR(SETTLEMENT_DATE) AS YEARSETTLED,
				COUNT(DISTINCT C.CASE_ID) AS NOOFCASES,
				AVG(DATEDIFF(D,DATE_OPENED,SETTLEMENT_DATE)) AS AVGDAYSSETTLED 
			FROM 
