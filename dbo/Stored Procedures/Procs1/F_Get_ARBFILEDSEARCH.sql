CREATE PROCEDURE [dbo].[F_Get_ARBFILEDSEARCH]   --[dbo].[F_Get_ARBFILED] '01/14/2015','01/16/2015','1','4425'
(
	@dt_From nvarchar(50),
	@dt_To nvarchar(50),
	@rblArb INT,
...
AS  
	...
	DECLARE @strsql VARCHAR(MAX)
		IF (@rblArb = '1')
		BEGIN
			SET @strsql  = 'SELECT LCJ.Case_Id,
		   (LCJ.InjuredParty_FirstName +'' ''+ LCJ.InjuredParty_LastName) as Patient,
			LCJ.Provider_Name,
			LCJ.InsuranceCompany_Name,
			LCJ.Status,
			Convert(varchar,IT.DateInserted,101) as DateInserted,
			I.Filename,
			I.FilePath
