CREATE PROCEDURE [dbo].[batch_print_offline_email_status_save] 
	...
	@emailStatusDate			DATETIME,	
	@emailAcknowledgementKey	UNIQUEIDENTIFIER,
	@ResendCount				INT
AS BEGIN
	...
	BEGIN
			...
			(
				...
				emailStatusDate,				
				isDeleted,
				emailAcknowledgementKey,
				isEmailAcknowledged,
				emailAcknowledgementDate,				
				in_progress,
				ResendCount
			)
			VALUES
	...
	BEGIN
			...
			SET
				...
				emailStatusDate			=	@emailStatusDate,
